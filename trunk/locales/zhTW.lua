...
L["Adds a new buff to the status module"] = "狀態模组添加一個新的增益"
L["<buff name>"] = "<增益名稱>"
L["Add new Debuff"] = "添加新的减益"
L["Adds a new debuff to the status module"] = "狀態模组添加一個新的減益"
L["<debuff name>"] = "<減益名称>"
L["Delete (De)buff"] = "刪除增（減）益"
L["Deletes an existing debuff from the status module"] = "刪除狀態模组內已有的一個增（減）益"
...
L["Show on %s."] = "在%s上顯示。"
L["Show if missing"] = "缺少时顯示"
L["Display status only if the buff is not active."] = "僅在增益缺少时才顯示狀態。"
...
L["Mana"] = "法力"
L["Low Mana"] = "低法力"
L["Mana threshold"] = "法力臨界点"
L["Set the percentage for the low mana warning."] = "設定低法力警報的臨界点。"
...
L["Ignore Self"] = "忽略自己"
L["Ignore heals cast by you."] = "忽略对自己施放的治療。"
L["(.+) begins to cast (.+)."] = "(.+)開始施放(.+)。" --test
L["(.+) gains (.+) Mana from (.+)'s Life Tap."] = "(.+)从(.+)的生命分流獲得(.+)點法力值。" --test
L["^Corpse of (.+)$"] = "(.+)的尸體。$" --test
...
L["Offline warning"] = "掉線警報"
L["Health"] = "生命值"
L["Show dead as full health"] = "把死亡的顯示為滿血"
L["Treat dead units as being full health."] = "把死亡的單位顯示為滿血。"
L["Use class color"] = "使用職業顏色"
L["Color health based on class."] = "用職業顏色来顯示生命值。"
L["Health threshold"] = "生命值臨界点"
L["Only show deficit above % damage."] = "只顯示已經损失了%的生命值。"
L["Color deficit based on class."] = "用職業顏色来顯示损失的生命值。"
L["Low HP threshold"] = "低生命值臨界点"
L["Set the HP % for the low HP warning."] = "設定低生命值警報的臨界点。"
