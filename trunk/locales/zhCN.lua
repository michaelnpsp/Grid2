...
L["Statuses"] = "状态"
L["Toggle status display."] = "选择显示状态。"

-- Advanced options
L["Enable %s indicator"] = "激活%s指示"
...
-- Layout options
L["Raid Layout"] = "团队布局"
L["Select which raid layout to use."] = "选择使用何种团队布局。"
...
L["Onyxia"] = "单数双数队伍排列"
L["By Group 25 w/tanks"] = "25人团队及 MT"
...
L["Range in yard beyond which the status will be lost."] = "超出距离以外的状态都将丢失。"
L["%d yards"] = "%d码"
