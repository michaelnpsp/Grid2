	...
	for i, layer in pairs(layers) do
		...
		elseif (layer == "paladin") then
			if (versions.paladin.Grid2Options < 1) then
				...
				DBL:SetupLayerObject(dblData, "statuses", layer, "buff-BeaconOfLight", {type = "buff", spellName = 53563, color1 = {r=.7,g=1,b=1,a=1}})
				DBL:SetupLayerObject(dblData, "statuses", layer, "buff-BeaconOfLight-mine", {type = "buff", spellName = 53563, mine = true, color1 = {r=1,g=1,b=1,a=1}})
