...
function Grid2Options:SetupDefaultLocations(setup, class)
	setup.locations = {
...
--]]
function Grid2Options:SetupDefaultIndicators(setup, class)
...
function Grid2Options:SetupIndicatorStatus(setupIndicator, indicatorKey, statusKey, priority)
...
function Grid2Options:SetupDefaultStatus(setup, class)
	...
	self:SetupIndicatorStatus(setupIndicator, "text-down", "role", 45)
	self:SetupIndicatorStatus(setupIndicator, "text-down", "pvp", 40)
	...
	self:SetupIndicatorStatus(setupIndicator, "text-down-color", "role", 45)
	self:SetupIndicatorStatus(setupIndicator, "text-down-color", "pvp", 40)
...
function Grid2Options:SetupDefaultAuras(setup, class)
	local setupIndicator = setup.status
...
function Grid2Options:SetupDebuffPriorities(setup, class)
	local setupIndicator = setup.status
