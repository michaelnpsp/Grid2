...
L["Hide the Cooldown Animation Texture"] = true
L["Animations"] = true
...
L["Buffs: Raid Wide Defensive Cooldowns"] = true
L["Buffs: Tanks Active Mitigation"] = true
...
L["Change the name of the current profile."] = true
L['Default Profile'] = true
L["Select the profile to use if no profile is assigned to the character."] = true
...
L["Smart Center Align"] = true
L["Dinamically center the visible icons. Not available for multi-row configurations."] = true
