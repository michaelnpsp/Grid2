...
L["Available statuses you may add to the indicator"] = "Доступные статусы которые вы можете добавить на индикатор"
...
L["Current statuses of the indicator in order of priority"] = "Текущий статус в индикаторе, в порядке очередности"
L["Delete"] = "Удалить"
