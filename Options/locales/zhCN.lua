...
L["Debug"] = "除错"
L["Debugging"] = "除错"
L["Module debugging menu."] = "除错模块设置。"
...
L["Toggle debugging for %s."] = "激活%s的除错。"

L["Show Frame"] = "显示框架"
L["Sets when the Grid is visible: Choose 'Always', 'Grouped', or 'Raid'."] = "选择什么时候显示Grid：“一直”，“组队”或“团队”。"
L["Always"] = "一直"
L["Grouped"] = "组队"
L["Raid"] = "团队"
...
L["Switch between horzontal/vertical groups."] = "选择横向/竖向显示队伍。"
...
L["Border"] = "边缘"
L["Adjust border color and alpha."] = "调整边缘的颜色和透明度。"
L["Background"] = "背景"
...
L["Color"] = "颜色"
L["Color for %s."] = "%s的颜色。"
L["Color Charmed Unit"] = "高亮魅惑单位"
L["Color Units that are charmed."] = "高亮显示被魅惑单位。"
L["Unit Colors"] = "单位颜色"
L["Charmed unit Color"] = "魅惑单位颜色"
