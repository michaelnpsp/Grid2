...
L["Raid 40 Layout"] = "Agencement de Raid 40"
L["Select which layout to use for raid."] = "Choisir l'agencement à utiliser en Raid."
L["Heroic Raid Layout"] = "Agencement de Raid Héroique"
L["Select which layout to use for raid in heroic mode."] = "Choisir l'agencement à utiliser en Raid Héroique."
...
L["Toggle whether to permit movement out of screen."] = "Cocher pour autoriser les mouvements hors de l'écran."
...
L["healing-prevented"] = "soin-évité"
...
L["Current statuses in order of priority"] = "Statuts actuels dans l'ordre de priorité"
L["Delete"] = "Effacer"
...
L["Reset and ReloadUI."] = "Reset et reloadUI."
L["Reset Categories"] = "Réinitialiser les catégories"
L["Reset categories to the default list."] = "Remettre les catégories par défaut."
L["Reset Indicators"] = "Réinitialiser les indicateurs"
L["Reset indicators to defaults."] = "Remettre les indicateurs par défaut."
L["Reset Locations"] = "Réinitialiser emplacements"
L["Reset locations to the default list."] = "Réinitialiser les emplacements par défaut."
L["Reset Statuses"] = "Réinitialiser les Statuts"
L["Reset statuses to defaults."] = "Valeurs par défaut des statuts."
L["Select statuses to display with the indicator"] = "Sélectionner les statuts ࡡfficher avec l'indicateur"
