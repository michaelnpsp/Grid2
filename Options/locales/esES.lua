...
L["Default Settings"] = "opciónes Predeterminadas"
...
L["Forbid dynamic changes in frame dimensions for this kind of header."] = "Prohibe el redimensionado dinamico del tamaño de los marcos."
...
L["Enable this option to hide the default blizzard border of buffs and debuffs Icons."] = "Activa estas opción para ocultar el borde predeterminado de los beneficios y debuffs."
...
L["Reset Locations"] = "Reiniciar posiciónes"
L["Reset locations to the default list."] = "Reinicia las posiciónes a los valores predeterminados."
...
L["General Options"] = "opciónes Generales"
...
L["Import/export options"] = "opciónes de importación y exportación"
...
-- Open manager
L["Options management"] = "Funcionamiento opciónes"
L["Load options on demand (requires UI reload)"] = "Crear las opciónes bajo demanda (requiere recargar UI)"
L["OPTIONS_ONDEMAND_DESC"] = "Las opciónes no son creadas hasta que el usuario hace click sobre ellas, lo que reduce la memoria usada y tiempo de carga. Si tiene algun problema con esta caracteristica, desactive esta opción."
...
L["This setting is used to setup different layouts, frame sizes or themes depending of the raid size."] = "Permite seleccionar diferentes diseños, tamaños de celda o temas segun el tamaño de la banda."
