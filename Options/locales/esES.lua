...
L["GRID2_DESC"] = "Grid2 es un addon de marcos de unidades. Grid2 muestra la vida y toda la información importante de los miembros del grupo o raid de una manera mas comprensible."
...
L["Right Click Menu"] = "Menú en Click Derecho"
...
L["Main Window Position"] = "Posición  ventana principal"
...
L["Module debugging menu."] = "Menú de depuración del modulo"
L["Debug"] = "Depuración"
L["Reset"] = "Reiniciar"
L["Reset and ReloadUI."] = "Reinicia y Recarga el Interface."
...
L["Mythic raids Instances"] = "Instancias Míticas"
...
L["When the player is in a vehicle replace the player frame with the vehicle frame."] = "Si el jugador se encuentra dentro de un vehículo, sustituir al jugador por su vehículo."
L["Header"] = "Cabecera"
...
L["Display all raid groups, if unchecked the groups will by filtered according to the instance size. Not all layouts will obey this setting."] = "Mostrar todos los grupos de raid, si no se activa los grupos se filtrarán de acuerdo con el tamaño de la instancia. No todos los diseños obedecen a este ajuste."
L["Sort units by name"] = "Ordena unidades por nombre"
L["Sort the units by player name, if unchecked the units will be displayed in raid order. Not all layouts will obey this setting."] = "Ordena las unidades por nombre de jugador, si no se activa las unidades se mostrarán por orden de raid. No todos los diseños obedecen a este ajuste."
...
L["Create a new user defined layout by entering a name in the editbox."] = "Para crea un nuevo diseño personalizado teclea un nombre en la caja de edición."
...
L["Disable the Cooldown Frame"] = "Desactiva la animación del Cooldown"
...
L["Hide the Cooldown Animation Texture"] = "Oculta la textura de la animación del Cooldown"
...
L["Maximum number of characters to show."] = "Número máximo de caracteres a mostrar."
...
L["Line Position"] = "Posición Linea"
L["Fine adjust the position of the line relative to the previous bar."] = "Ajuste fino de la posición de la linea."
...
L["Display cooldown numbers."] = "Muestra números para el cooldown."
...
L["Multiple instances of the same debuff will be treated as multiple stacks of the same debuff."] = "Multiples instancias de un debuff serán mostradas como acumulaciones de un mismo debuff."
...
L["Raid&Party Roles"] = "Roles de Raid&Grupo"
...
L["Name or SpellId"] = "Nombre o Número de hechizo"
...
L["Allowed debuffs"] = "Debuffs permitidos"
L["Listed debuffs will be ignored."] = "Los debuffs añadidos e esta lista serán ignorados."
L["AURAVALUE_DESC"] = "Selecciona el valor a monitorizar. Hasta 3 posibles valores puede tener un aura, pero no todas las auras tienen valores adicionales. Ejemplos de auras con información extra: escudos de sacerdotes (el valor del escudo se guarda en Valor1) o el debuff Purgatorio de los Caballeros de la Muerte."
L["Enabled for"] = "Habilitado para"
L["All Classes"] = "Todas las clases"
L["Activation Stacks"] = "Acumulaciones"
L["Select the minimum number of aura stacks to activate the status."] = "Selecciona el mínimo número de acumulaciones del aura para activar el estado."
...
L["Buffs: Raid Wide Defensive Cooldowns"] = "Buffs: Cooldowns defensivos de Raid"
L["Buffs: Tanks Active Mitigation"] = "Buffs: Mitigación activa de Tanques"
L["Debuffs: Healing Prevented "] = "Debuffs: Impiden curación"
L["Debuffs: Healing Reduced"] = "Debuffs: Reducen curación"
L["Non Boss Debuffs"] = "Debuffs generales"
L["Boss Debuffs"] = "Debuffs de Jefes"
L["Short Duration"] = "Corta duración"
L["Long Duration"] = "Larga duración"
...
L["ChainHeal"] = "Sanación en cadena"
...
L["Ready color"] = "Listo"
L["Color for Ready."] = "Color si el jugador está listo"
L["Not Ready color"] = "No Listo"
L["Color for Not Ready."] = "Color si el jugador no está listo"
L["AFK color"] = "Ausente"
...
L["A resurrection spell is being casted on the unit"] = "Alguien está resucitando a esta unidad"
...
L["Player accepted the summon."] = "El jugador ha aceptado la invocación."
L["Summon Declined"] = "Invocación Cancelada"
L["Player declined the summon."] = "El jugador no ha aceptado la invocación."

-- unit-index status
L["Enabled only for party units"] = "Activado solo para unidades de grupo"
L["Raid indexes will not be displayed."] = "No se mostrarán los índices de unidades de raid."
...
L["advanced threat detection"] = "detección avanzada de amenaza"
...
L["Minimum players to enable the status."] = "Minimo número de jugadores para activar el estado."
L["Radius"] = "Radio"
...
L["Maximum number of solutions to display."] = "Maximo número de soluciones a mostrar."
L["Hide on cooldown"] = "Ocultar en cooldown"
L["Hide the status while the spell is on cooldown."] = "Oculta el estado mientras el hechizo de curación este en cooldown."
...
L["Show in Encounter Journal"] = "Mostrar Guía de mazmorras"
...
L["RaidDebuffs Autodetection"] = "RaidDebuffs Autodetección"
L["Debuffs Autodetection"] = "Autodetección de Debuffs"
L["Enable Autodetection"] = "Activar Autodetección"
L["Enable Zones and Debuffs autodetection"] = "Activa la autodetección de zonas y debuffs"
...
L["Copy the settings from one existing profile into the currently active profile."] = "Copia la configuración del perfil seleccionado en el perfil actual."
...
L["When enabled, your profile will be set according to the character specialization."] = "Activa esta opción para elegir perfiles distintos para cada especialización."
...
L["Delete the selected indicator."] = "Eliminar el indicador seleccionado."
...
L["Auto"] = "Auto"
L["Automatic filter: groups will by filtered according to the instance size, for example for a 10 man raid instance, only players in groups 1&2 will be displayed."] = "Filtro automatico: los grupos se mostrarán de acuerdo con el número maximo de jugadores permitidos en la estancia."
L["Add a new header.\nA header displays a group of players or pets in a compat way."] = "Añade una nueva cabecera.\nUna cabecera muestra un grupo de jugadores o mascotas de una forma compacta."
L["Editor"] = "Editor"
...
L["Thickness"] = "Grosor"
L["Number of particles"] = "Número de partículas"
...
L["Select maximum number of icons to display."] = "Elige maximo número de iconos a mostrar."
L["Select the number of icons per row."] = "Elige número de iconos por fila."
...
L["Enable this option to display the default unit tooltip when Out of Combat."] = "Activa esta opción para mostrar el tooltip predeterminado estando fuera de combate."
...
L["Aura Name or Spell ID"] = "Aura o Número Hechizo"
L["Change Buff/Debuff Name or Spell ID."] = "Cambia el nombre del buff/debuff o el número de hechizo (spellID)"
...
L["Dispellable by Me"] = "Disipables por Mi"
L["Display debuffs i can dispell"] = "Mostrar debuffs que puedo disipar"
L["Non Dispellable by Me"] = "No Disipables por Mi"
...
L["Display debuffs with duration below 5 minutes."] = "Muestra debuffs con duración menor de 5 minutos."
L["Display debuffs with duration above 5 minutes."] = "Muestra debuffs con duración mayor de 5 minutos."
L["Display debuffs with a duration."] = "Muestra debuffs con duración."
L["Display debuffs with no duration."] = "Muestra debuffs sin duración."
...
L["Always display direction for mouseover"] = "Muestra dirección para mouseover"
L["Target Unit"] = "Objetivo"
L["Always display direction for target"] = "Muestra dirección para la unidad en objetivo"
L["Focus Unit"] = "Foco"
L["Always display direction for focus"] = "Mostrar direción para la unidad en foco"
...
L["Add heal spells"] = "Añade hechizos de curación"
...
L["Select heal spells"] = "Elige hechizos de curación"
...
L["Shorten Heal Numbers"] = "Acorta números (curas)"
L["Shorten Health Numbers"] = "Acorta números (vidas)"
L["Shorten Thousand Numbers"] = "Acorta números por encima de mil"
L["Shorten Above Million Numbers"] = "Acorta números por encima de un millon"
...
L["Incoming overheals below the specified value will not be shown."] = "No se mostrará la sobrecuración por debajo del valor indicado."
L["Shorten Overhealing Numbers"] = "Acortar números (sobrecuracion)"
...
L["Number of non-empty raid groups"] = "Número de grupos de raid en uso"
L["Number of players in raid"] = "Número de jugadores en raid"
...
L["Enable multiple icons support for icons indicators."] = "Activa la visualización de multiples iconos."
...
L["Load the status only if your toon has the specified class and specialization."] = "Cargar el estado solo si tu personjae pertenece a la clase y especialización indicadas."
