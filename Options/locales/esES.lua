...
L["Display the standard unit menu when right clicking on a frame."] = "Mostrar el menú de unidad estándar al hacer clic derecho en una celda."
...
L["Sets the hightlight color of each unit frame"] = "Ajusta el color de resaltado de la celda cuando el ratón está sobre ella"
L["Highlight Texture"] = "Textura Resaltado"
L["Sets the highlight border texture of each unit frame"] = "Ajusta la textura del borde de la celda cuando el ratón está sobre ella"
...
L["Allows mouse click through the Grid Frame."] = "Permitir hacer clics a través de las celdas del Grid2"
...
L["my-heals-incoming"] = "sanaciónes (mías)"
L["boss-debuffs"] = "Perjuicios de Jefes"
...
L["Examples:\n%dm\n%d minutes"] = "Ejemplos:\n%dm\n%d minutos"
L["Enable Durations"] = "Activar duraciónes"
