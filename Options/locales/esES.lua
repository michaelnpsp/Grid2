...
L["Right Click Menu"] = "Menú en Clic Derecho"
L["Display the standard unit menu when right clicking on a frame."] = "Mostrar el menú de unidad estándar al hacer clic derecho en un marco."
...
L["Sets the background color of each unit frame"] = "Elige el color de fondo de los marcos."

L["Mouseover Highlight"] = "Resaltar marco del ratón"
L["Toggle mouseover highlight."] = "Activa esta opción para que el marco bajo el ratón sea resaltada."
L["Highlight Color"] = "Color Resaltado"
L["Sets the hightlight color of each unit frame"] = "Ajusta el color de resaltado de el marco cuando el ratón está sobre ella"
L["Highlight Texture"] = "Textura Resaltado"
L["Sets the highlight border texture of each unit frame"] = "Ajusta la textura del borde de el marco cuando el ratón está sobre ella"

L["Main Background"] = "Fondo Principal"
L["Secondary Background"] = "Fondo Secundario"

L["Background Texture"] = "Textura del Fondo"
L["Select the frame background texture."] = "Elige la textura del fondo de los marcos"

L["Inner Border Size"] = "Grosor borde interior"
L["Sets the size of the inner border of each unit frame"] = "Ajusta el tamaño del borde interior de los marcos."

L["Inner Border Color"] = "Color border interior"
L["Sets the color of the inner border of each unit frame"] = "Ajusta el color del borde interior de los marcos."

L["Frame Width"] = "Ancho marcos"
L["Adjust the width of each unit's frame."] = "Ajusta el ancho de los marcos."

L["Frame Height"] = "Alto marcos"
L["Adjust the height of each unit's frame."] = "Ajusta el alto de los marcos."

L["Default Orientation"] = "Orientación predeterminada"
L["Set default bars orientation."] = "Elige la orientación predeterminada de las barras de los marcos."
L["VERTICAL"] = "Vertical"
...
L["Frame lock"] = "Marcos bloqueados"
L["Locks/unlocks the grid for movement."] = "Bloquea o desbloquea el movimiento de la ventana del Grid2"
L["Click through the Grid Frame"] = "Clic a través de Grid2"
L["Allows mouse click through the Grid Frame."] = "Permitir hacer clics a través de los marcos del Grid2"

L["Display"] = "Mostrar"
L["Padding"] = "Espacio entre marcos"
L["Adjust frame padding."] = "Ajusta el espacio entre los marcos del Grid2."
...
L["Frames Look&Feel"] = "Marcos: Apariencia"
...
L["Lock Frame Size"] = "Bloquear Tamaño Marcos"
L["Forbid dynamic changes in frame dimensions for this kind of header."] = "Prohibe el redimensionado dinámico del tamaño de los marcos."
L["Adjust the width percent of each unit's frame."] = "Ajusta el ancho de cada marco como porcentaje."
L["Adjust the height percent of each unit's frame."] = "Ajusta la altura de cada marco como porcentaje."
...
L["Zoom In buffs and debuffs icon textures"] = "Ampliar las texturas de los iconos de beneficios y perjuicios"
L["Enable this option to hide the default blizzard border of buffs and debuffs Icons."] = "Activa estas opción para ocultar el borde predeterminado de los beneficios y perjuicios."
...
L["Duration Format"] = "Duración"
L["Examples:\n(%d)\n%d seconds"] = "Ejemplos:\n(%d)\n%d segundos"
L["Duration+Stacks Format"] = "Duración+Acumulaciones"
L["Examples:\n%d/%s\n%s(%d)"] = "Ejemplos:\n%d/%s\n%s(%d)"
L["Display tenths of a second"] = "Mostrar décimas de segundo"
L["When duration<1sec"] = "Si duración < 1 segundo"
...
L["Module debugging menu."] = "Menú de depuración de módulo"
L["Debug"] = "Depuración"
L["Reset"] = "Reiniciar"
L["Reset and ReloadUI."] = "Reinicia y Recarga la interfaz."
L["Reset Setup"] = "Reinicia la configuración"
L["Reset current setup and ReloadUI."] = "Reinicia la configuración y recarga el Interface."
L["Reset Indicators"] = "Reiniciar Indicatores"
L["Reset indicators to defaults."] = "Reinicia los indicadores a los valores predeterminados."
L["Reset Locations"] = "Reiniciar posiciones"
L["Reset locations to the default list."] = "Reinicia las posiciones a los valores predeterminados."
L["Reset to defaults."] = "Reinicia a los valores prededeterminados"
L["Reset Statuses"] = "Reiniciar Estados"
L["Reset statuses to defaults."] = "Reinicia los estados a los valores predeterminados"
L["Reset Position"] = "Reiniciar Posición"

L["Warning! This option will delete all settings and profiles, are you sure ?"] = "¡Atención! Esta opción borrará toda la configuración y los perfiles definidos. ¿Estás seguro?"
...
L["Use Raid layout"] = "Usar diseño de Banda"
L["Solo"] = "Solo"
L["Party"] = "Grupo"
L["Arena"] = "Arena"
L["Raid"] = "Banda"
L["PvP Instances (BGs)"] = "Estancias JcJ (CDB)"
L["LFR Instances"] = "Buscador de bandas"
L["Flexible raid Instances (normal/heroic)"] = "Bandas Flexibles (normal/heroico)"
L["Mythic raids Instances"] = "Estancias Míticas"
L["Other raids Instances"] = "Otras estancias de banda"
L["In World"] = "En el mundo"
L["Layout Settings"] = "Diseño"
L["Solo Layout"] = "Diseño Solo"
L["Party Layout"] = "Diseño en grupo"
L["Raid %s Layout"] = "Diseño en Banda %s"
L["Select which layout to use for %s person raids."] = "Elige el diseño a usar cuando estas en Banda de %s."
L["Battleground Layout"] = "Diseño para BGs"
L["Select which layout to use for battlegrounds."] = "Elige el diseño a usar para CBD."
...
L["Insert"] = "Añadir"
L["Copy"] = "Copiar"
L["By Instance Type"] = "Por tipo de estancia"
L["By Raid Size"] = "Por tamaño de banda"
L["Spec"] = "Spec"
L["Select which layout to use for solo."] = "Elige el diseño a usar cuando estás solo."
L["Select which layout to use for party."] = "Elige el diseño a usar cuando estás en grupo."
L["%d man instances"] = "Estancias de %d jugadores"
L["Display all groups"] = "Muestra todos los grupos"
L["Display all raid groups, if unchecked the groups will by filtered according to the instance size. Not all layouts will obey this setting."] = "Mostrar todos los grupos de banda, si no se activa los grupos se filtraran de acuerdo con el tamaño de la estancia. No todos los diseños obedecen a este ajuste."
L["Sort units by name"] = "Ordena unidades por nombre"
L["Sort the units by player name, if unchecked the units will be displayed in raid order. Not all layouts will obey this setting."] = "Ordena las unidades por nombre de jugador, si no se activa las unidades se mostrarán por orden de banda. No todos los diseños obedecen a este ajuste."
...
L["Type the name of the new Layout:"] = "Escribe el nombre del nuevo diseño:"
...
L["Create Indicator"] = "Crear Indicador"
...
L["Disable Cooldown"] = "Ocultar Reutilización"
L["Disable the Cooldown Frame"] = "Desactiva la animación de la reutilización"
L["Reverse Cooldown"] = "Invertir Reutilización"
L["Set cooldown to become darker over time instead of lighter."] = "Reutilización se oscurecerá con el tiempo."
L["Cooldown"] = "Reutilización"
L["Text Location"] = "Posición del texto"
L["Disable OmniCC"] = "Desactivar OmniCC"
L["Hide Animation"] = "Ocultar Animación"
L["Hide the Cooldown Animation Texture"] = "Oculta la textura de la animación de la reutilización"
L["Animations"] = "Animaciones"
L["Enable animation"] = "Activar animación"
L["Turn on/off zoom animation of icons."] = "Activa/desactiva animación de zoom del icono"
L["Duration"] = "Duración"
L["Sets the duration in seconds."] = "Duración en segundos."
L["Scale"] = "Escala"
...
L["Text Length"] = "Longitud del Texto"
...
L["Width"] = "Anchura"
L["Adjust the width of the indicator."] = "Anchura del indicador."
L["Height"] = "Altura"
L["Adjust the height of the indicator."] = "Altura del indicador."
L["Rectangle"] = "Rectángulo"
L["Allows to independently adjust width and height."] = "Permite indicar la anchura y la altura de forma independiente."
...
L["Choose zero to set the bar to the same width as parent frame"] = "Si elige cero la barra tendrá el mismo ancho que el marco"
L["Bar Height"] = "Alto de la barra"
L["Choose zero to set the bar to the same height as parent frame"] = "Si elige cero la barra tendrá el mismo alto que el marco"
...
L["Fill bar in reverse"] = "Invertir la dirección de la barra"
L["Anchor & Direction"] = "Anclaje & Dirección"
L["Select where to anchor the bar and optional you can reverse the grow direction."] = "Elige donde anclar la barra, opciónalmente puedes invertir la dirección de la barra."
L["Previous Bar"] = "Barra Previa"
L["Topmost Bar"] = "Barra mas Alta"
L["Previous Bar & Reverse"] = "Barra previa y Invertir"
L["Glow Line"] = "Línea Brillante"
L["Line"] = "Línea"
L["Line Thickness"] = "Grosor de la Línea"
L["Set the thickness of the glow line."] = "Configura el grosor de la línea."
L["Line Position"] = "Posición de la Línea"
L["Fine adjust the position of the line relative to the previous bar."] = "Ajuste fine de la posición de la línea."

L["Border Size"] = "Grosor del borde"
L["Adjust the border of each unit's frame."] = "Ajusta el grosor del borde de cada marco"
...
L["This option takes priority over any other tooltip configuration."] = "Esta opción tiene prioridad sobre cualquier otra configuración."
L["Never"] = "Nunca"
L["Always"] = "Siempre"
...
L["Check this option to display a tooltip when the mouse is over the icon."] = "Activa esta opción para mostrar un tooltip cuando el ratón esta sobre el icono."
...
L["Check this option to display a tooltip when the mouse is over this indicator."] = "Activa esta opción para mostrar un tooltip cuando el ratón esta sobre este indicador."
...
L["Icon Spacing"] = "Separación"
L["Direction"] = "Dirección"
L["Select the direction of the main bar."] = "Elige la dirección de la barra principal."

L["First Aura"] = "Primera Aura"
L["Select the index of the first private aura to display."] = "Selecciona el índice de la primera aura privada a mostrar."
L["Last Aura"] = "Ultima Aura"
L["Select the index of the last private aura to display."] = "Selecciona el índice de la ultima aura privada a mostrar."
L["Enable Cooldown"] = "Activar Reutilización"
L["Display a cooldown animation."] = "Muestra una animación para el cooldown."
L["Enable Numbers"] = "Activar Números"
L["Display cooldown numbers."] = "Muestra numeros para la reutilización."
...
L["Location"] = "Posición"
L["Align my align point relative to"] = "Elige la posición de el marco donde se anclará el indicador"
L["Align Point"] = "Punto a alínear"
...
L["buff"] = "beneficio"
L["debuff"] = "perjuicio"
L["debuffType"] = "Tipo de perjuicio"
L["buffs-"] = "beneficios: "
L["debuffs-"] = "perjuicios: "


L["New Buff"] = "Nuevo Beneficio"
L["New Debuff"] = "Nuevo Perjuicio"
...
L["Create Buff"] = "Crear Beneficio"
L["Create Debuff"] = "Crear Perjuicio"
...
L["Multiple instances of the same debuff will be treated as multiple stacks of the same debuff."] = "Multiples estancias de un perjuicio serán mostradas como acumulaciones de un mismo perjuicio."
...
L["Debuffs"] = "Perjuicios"
L["Colors"] = "Colores"
L["Health&Heals"] = "Vida y Sanaciones"
L["Mana&Power"] = "Maná y Poder"
L["Combat"] = "Combate"
L["Targeting&Distances"] = "Objetivos y Distancias"
L["Raid&Party Roles"] = "Roles de Banda y Grupo"
...
L["Display status only if the buff is not active."] = "Mostrar el estado solo si el beneficio no esta activo"
L["Hide on pets"] = "Oculto en pets"
L["Never display this status on pets."] = "Nunca mostrar este estado para las mascotas."
L["Display status only if the buff was cast by you."] = "Mostrar el estado solo si el beneficio ha sido lanzado por ti"
L["Display status only if the buff was not cast by you."] = "Mostrar el estado solo si el beneficio no ha sido lanzado por ti"
...
L["Single Color"] = "Color Único"
L["Debuff Type"] = "Tipo de Perjuicio"
L["Number of stacks"] = "Número de Acumulaciones"
...
L["Buff"] = "Beneficio"
L["Debuff"] = "Perjuicio"
L["Buffs Group"] = "Grupo Beneficios"
L["Debuffs Group"] = "Grupo Perjuicios"
L["Filtered debuffs"] = "Perjuicios filtrados"
L["Allowed debuffs"] = "Perjuicios permitidos"
L["Listed debuffs will be ignored."] = "Los perjuicios añadidos e esta lista serán ignorados."
L["AURAVALUE_DESC"] = "Selecciona el valor a monitorizar. Hasta 3 posibles valores puede tener un aura, pero no todas las auras tienen valores adicionales. Ejemplos de auras con informacion extra: escudos de sacerdotes (el valor del escudo se guarda en Valor1) o el perjuicio Purgatorio de los Caballeros de la Muerte."
...
L["Track"] = "Monitorizar"
L["Duration&Stacks"] = "Duración y Acumulaciones"
L["Value"] = "Valor"
L["Value Index"] = "Valor (índice)"
L["Value Track"] = "Monitorizar Valor"
L["NONE"] = "Ninguno"
L["Value1"] = "Valor1"
L["Value2"] = "Valor2"
L["Value3"] = "Valor3"
L["Maximum Value"] = "Valor máximo"
...
L["Buffs: Defensive Cooldowns"] = "Beneficios: Reuitilizaciones defensivos"
L["Buffs: Raid Wide Defensive Cooldowns"] = "Beneficios: Reutilizaciones defensivos de Banda"
L["Buffs: Tanks Active Mitigation"] = "Beneficios: Mitigación activa de Tanques"
L["Debuffs: Healing Prevented "] = "Perjuicios: Impiden sanación"
L["Debuffs: Healing Reduced"] = "Perjuicios: Reducen sanación"
L["Non Boss Debuffs"] = "Perjuicios generales"
L["Boss Debuffs"] = "Perjuicios de Jefes"
L["Short Duration"] = "Duración Corta"
L["Long Duration"] = "Duración Larga"
L["Temporary Debuffs"] = "Perjuicios temporales"
L["Permanent Debuffs"] = "Perjuicios permanentes"
L["Non Self Casted"] = "No propios"
L["Self Casted"] = "Propios"
L["Relevant Debuffs"] = "Perjuicios relevantes"
L["Non-Relevant Debuffs"] = "Perjuicios no relevantes"
L["Whitelist"] = "Lista blanca"
L["Blacklist"] = "Lista negra"
L["Use debuff Type color"] = "Color tipo de perjuicio"
L["Use the debuff Type color first. The specified color will be applied only if the debuff has no type."] = "Usar el color del tipo de perjuicio. El color configurado solo se usará si el perjuicio no tiene tipo."
...
L["raid-icon-player"] = "banda-icono-jugador"
L["raid-icon-target"] = "banda-icono-objetivo"
L["range"] = "rango"
L["rangealt"] = "rango alternativo"
L["ready-check"] = "comprobación listos"
L["role"] = "rol"
L["dungeon-role"] = "rol en mazmorra"
L["spec-role"] = "rol por especialización"
L["leader"] = "lider"
L["master-looter"] = "maestro despojador"
L["raid-assistant"] = "ayudante de banda"
L["target"] = "objetivo"
L["threat"] = "amenaza"
L["banzai"] = "banzai"
...
L["pvp"] = "jcj"
L["direction"] = "dirección"
L["resurrection"] = "resurección"
L["self"] = "yo mismo"
L["boss-shields"] = "escudos de jefes"
L["my-heals-incoming"] = "sanaciones (mías)"
L["boss-debuffs"] = "Perjuicios de Jefes"
L["unit-index"] = "índice unidad"
...
L["raid-debuffs2"] = "Perjuicios de Banda(2)"
L["raid-debuffs3"] = "Perjuicios de Banda(3)"
L["raid-debuffs4"] = "Perjuicios de Banda(4)"
L["raid-debuffs5"] = "Perjuicios de Banda(5)"
...
L["HealingRain"] = "Lluvia de sanación"
...
L["CircleOfHealing"] = "Circulo de sanación"
L["PrayerOfHealing"] = "Rezo de sanación"
...
L["Invert status activation"] = "Invertir activación del estado"
...
L["Heal Range"] = "Rango Sanaciones"
L["Spell Range"] = "Rango Hechizos"
L["Range by class"] = "Rango por clase"
L["Check this option to setup different range configuration for each player class."] = "Activa esta opción para guardar diferentes configuraciones para cada clase."
...
L["AFK color"] = "Ausente"
L["Color for AFK."] = "Color si el jugador está Ausente"
...
L["Substract heal absorbs"] = "Restar absorciones"
L["Substract heal absorbs shields from the incoming heals"] = "Restar a las curas entrantes los escudos que absorben sanación"
...
L["Heals multiplier"] = "Multiplicador de sanaciones"
...
L["Copy to Debuffs"] = "Copiar a Perjuicios"
...
L["New raid debuff"] = "Nuevo perjuicio de banda"
L["Type the SpellId of the new raid debuff"] = "Escribe el número de hechizo (SpellId) del perjuicio de banda"
L["Create raid debuff"] = "Crear perjuicio de banda"
L["Delete raid debuff"] = "Eliminar este perjuicio"
...
-- shields status
L["shields"] = "escudos"
L["Maximum shield amount"] = "Valor máximo"
...
-- heal-absorbs status
L["heal-absorbs"] = "absorción curas"
L["Maximum absorb amount"] = "Valor máximo"
...
L["Enable this option to invert the status so it will become activated when the player is Out Of Combat."] = "Activa estas opción para invertir el estado de modo que sea activado fuera de combate."

-- pvp status
L["Hide inside Instances"] = "Ocultar en Estancias"
...
L["Summon Accepted"] = "Invocación Aceptada"
L["Player accepted the summon."] = "El jugador ha aceptado la invocacion."
L["Summon Declined"] = "Invocación Cancelada"
...
L["Raid indexes will not be displayed."] = "No se mostrarán los índices de unidades de banda."
L["Enabled for player unit"] = "Activado para la unidad del jugador"
L["Display a zero index for player unit while in party or raid."] = "Muestra un índice cero para la unidad del jugador mientras está en grupo o raid."

-- status descriptions
L["highlights your target"] = "resalta tu objetivo"
L["hostile casts against raid members"] = "casteos hostiles contra los miembros de la banda"
L["advanced threat detection"] = "deteccion avanzada de amenaza"
L["arrows pointing to each raid member"] = "flechas apuntando a cada miembro de la banda"
L["display remaining amount of heal absorb shields"] = "muestra escudos que absorben sanación"
...
L["AOE Heal"] = "Sanación en area"
L["Any Spell"] = "Cualquier hechizo"
L["Activation conditions"] = "Condiciones de activación"
L["Healing"] = "Sanación"
L["Damage"] = "Daño"
L["Cast Start"] = "Inicio de lanzamiento"
L["Cast Success"] = "Fin de lanzamiento"
...
L["Mouse Enter Delay"] = "Retraso entrada ratón"
L["Delay in seconds before showing the status."] = "Retraso en segundos antes de mostrar el estado, cuando el ratón entra en una unidad."
L["Mouse Leave Delay"] = "Retraso salida ratón"
L["Delay in seconds before hiding the status."] = "Retraso en segundos antes de ocultar el estado, cuando el ratón sale de una unidad."
...
L["Hide the status while the spell is on cooldown."] = "Oculta el estado mientras el hechizo de sanación este en reutilización."
...
L["Show only in raid"] = "Mostrar solo en banda"
L["Enable the statuses only in raid."] = "Mostrar los estados solo en banda."
...
L["Display all solutions instead of only one solution per group."] = "Muestra todas las soluciones en lugar de una sola solución por grupo."

-- raid debuffs
L["Debuff Configuration"] = "Configuración de Perjuicios"
L["Link to Chat"] = "Pegar en el Chat"
L["Show in Encounter Journal"] = "Mostrar Guia de mazmorras"
L["Encounter Journal difficulty"] = "Dificultad Guía de mazmorras"
...
L["Change the name of the current profile."] = "Cambia el nombre del perfil actual."
L['Default Profile'] = "Perfil por Defecto"
L["Select the profile to use if no profile is assigned to the character."] = "Selecciona un perfil para personajes sin perfil asignado."
L["You can assign a different database profile for each specialization, type of group or raid type."] = "Puedes asignar un perfil diferente para cada especialización, tipo de grupo o tipo de banda."
L["Enable profiles by Specialization"] = "Activar perfiles por Especialización"
L["When enabled, your profile will be set according to the character specialization."] = "Activa esta opción para elegir perfiles distintos para cada especializacion."
L["Enable profiles by Type of Group"] = "Activar perfiles por Tipo de Grupo"
L["When enabled, your profile will be set according to the type of group."] = "Activa esta opción para elegir perfiles distintos para cada tipo de grupo."
L["Enable profiles by Raid Type"] = "Activar perfiles por Tipo de Raid"
L["When enabled, profiles by raid type can be configured."] = "Activa esta opción para elegir perfiles distintos para cada tipo de banda."
...
L["OPTIONS_ONDEMAND_DESC"] = "Las opciones no son creadas hasta que el usuario hace click sobre ellas, lo que reduce la memoria usada y tiempo de carga. Si tiene algun problema con esta caracteristica, desactive esta opción."
...
L["Delete the selected indicator."] = "Eliminar el indicador selecionado."
L["Select a indicator to rename."] = "Elige el indicador a renombrar."
...
L["This status cannot be deleted because is attached to some indicators or the status is not enabled for this character."] = "Este estado no se puede eliminar porque esta enlazado a algun indicador."
L["Show relevant buffs for each unit frame (the same buffs displayed by the Blizzard raid frames)."] = "Muestra los beneficios relevantes para cada unidad (los mismos mostrados por la interfaz de Blizzard)."
...
L["You can change the active theme, you can also assign different themes for each specialization, group type, raid type or instance size."] = "Puedes cambiar el tema activo, tambien puedes asignar temas diferentes para cada especialización, tipo de grupo o estancia."
...
L["Special"] = "Especial"
L["Text"] = "Texto"
L["Toggle debugging for %s."] = "Cambia depuración para %s."
L["Resets the Grid2 main window position and anchor."] = "Reinicia la posición y anclajes de la ventana principal."
L["\"%s\" has sent you a profile configuration. Do you want to activate received profile ?"] = "\"%s\" te ha enviado una configuración para el Grid2. ¿Quieres activar el perfil recibido?"
...
L["Remove invalid or obsolete objects (indicators, statuses, etc) from the current profile database."] = "Elimina objectos obsoletos o inválidos del perfil actual."
...
L["Auto"] = "Auto"
L["Automatic filter: groups will by filtered according to the instance size, for example for a 10 man raid instance, only players in groups 1&2 will be displayed."] = "Filtro automatico: los grupos se mostrarán de acuerdo con el numero máximo de jugadores permitidos en la estancia."
L["Add a new header.\nA header displays a group of players or pets in a compat way."] = "Añade una nueva cabecera.\nUna cabecera muestra un grupo de jugadores o mascotas de una forma compacta."
L["Editor"] = "Editor"
...
L["shape"] = "figura"
L["Are you sure do you want to convert the indicator to the new selected type?"] = "Seguro que quieres convertir el indicador al nuevo tipo?"
L["Default:\nUse the size specified by the active theme.\nPixels:\nUser defined size in pixels.\nPercent:\nUser defined size as percent of the frame height."] = "Default:\nUsa el tamaño predeterminado del tema activo.\nPixels:\nTamaño personalizado en pixels.\nPercent:\nTamaño personalizado como porcentaje de la altura de el marco."
L["Pixels"] = "Píxeles"
...
L["Start the animation only when the indicator is activated, not on updates."] = "Inicia la animación cuando el indicador es activado, no cuando se actualiza."
L["Origin"] = "Origen"
L["Zoom origin point"] = "Punto origen Zoom"
L["This indicator cannot be changed from here: go to indicators section to assign/unassign statuses to this indicator."] = "Este indicador no se puede cambiar desde aqui."
...
L["Alpha/opacity when the indicator is not activated.\n0 = full transparent\n1 = full opaque"] = "Transparencia cuando el indicador no está activado\n0 = transparente\n1 = opaco"
L["Active Alpha"] = "Transparencia"
L["Use Status Alpha"] = "Usar transparencia del estado"
L["Check this option to use the alpha value provided by the active status."] = "Activa esta opción para usar el valor de transparencia suministrado por el estado activo."
...
L["Display the background even when the indicator is not active."] = "Mostrar el fondo incluso cuando el indicador no está activo."
...
L["Sets the glow color to use when the indicator is active."] = "Elige el color a usar cuando el indicador esta activo."
L["Glow Effect"] = "Efecto de brillo"
L["Select the glow effect."] = "Elige el efecto de brillo"
L["Animation Speed"] = "Velocidad Animación"
L["Number of Lines"] = "Numero de Líneas"
L["Thickness"] = "Grosor"
L["Number of particles"] = "Numero de partículas"
L["Scale of particles"] = "Escala de las partículas"
L["Pixel"] = "Píxel"
L["Shine"] = "Resplandor"
...
L["Smart Center Align"] = "Centrado inteligente"
L["Dinamically center the visible icons. Not available for multi-row configurations."] = "Centra dinámicamente los iconos visibles. No disponible para múltiples filas."
...
L["Select maximum number of icons to display."] = "Elige máximo numero de iconos a mostrar."
...
L["Prev. Bar & Reverse"] = "Barra Prev. y Invertir"
L["Whole Background"] = "Fondo completo"
L["Select bar texture."] = "Elige textura."
L["Color Source"] = "Origen de Color"
...
L["Show tooltip when mouseover a unit."] = "Muestra un Tooltip cuando el ratón esta sobre una unidad."
L["Enable this option to be able to customize the tooltip. Once enabled you can go to the 'statuses' tab to select which information you want to display."] = "Activa esta opción para personalizar el tooltip. Se mostrará una nueva pestaña donde elegir la información a mostrar."
L["Are you sure you want to disable the advanced tooltips?"] = "Seguro que quieres desactivar los tooltips avanzados?"
L["Enable this option to display the default unit tooltip when Out of Combat."] = "Activa esta opción para mostrar el tooltip por defecto estando fuera de combate."
...
L["Change Buff/Debuff Name or Spell ID."] = "Cambia el nombre del beneficio/debuff o el numero de hechizo (spellID)"
...
L["Dispellable by Me"] = "Disipable por Mi"
L["Display debuffs i can dispell"] = "Mostrar perjuicios que puedo disipar"
L["Non Dispellable by Me"] = "No Disipable por Mi"
L["Display debuffs i can not dispell"] = "Muestra debuffs que no puedo disipar"
...
L["Display debuffs with no type."] = "Muestra perjuicios sin tipo."
L["Display debuffs not casted by Bosses"] = "Muestra perjuicios no lanzados por jefes."
L["Display debuffs direct casted by Bosses"] = "Muestra perjuicios lanzados directamente por jefes."
L["Display debuffs with duration below 5 minutes."] = "Muestra perjuicios con duración menor de 5 minutos."
L["Display debuffs with duration above 5 minutes."] = "Muestra perjuicios con duración mayor de 5 minutos."
L["Display debuffs with a duration."] = "Muestra perjuicios con duración."
L["Display debuffs with no duration."] = "Muestra perjuicios sin duración."
L["Display non self debuffs"] = "Muestra perjuicios no propios"
L["Display self debuffs"] = "Muestra perjuicios propios"
L["Display only debuffs defined in a user defined list."] = "Muestra solo los perjuicios definidos en una lista."
L["Ignore debuffs defined in a user defined list."] = "Ignora los perjuicios definidos en una lista."
L["Type a list of debuffs, one debuff per line."] = "Teclea una lista de debuffs, un debuff por línea."
L["You can include a descriptive prefix using separators \"@#>\""] = "Puede especificar un prefijo usando los separadores \"@#>\""
L["Create a new Buff."] = "Crea nuevo Buff."
L["Display status only if the debuff was cast by you."] = "Muestra el estado solo si tu has originado el perjuicio."
L["Display status only if the debuff was not cast by you."] = "Muestra el estado solo si tu no has originado el perjuicio."
L["Use Empty Icon"] = "Usar Icono Vacío"
L["Displays an invisible Icon."] = "Muestra un icono invisible"
L["Color by distance"] = "Color por distancia"
L["Always display direction for tanks"] = "Muestra dirección para tanques."
L["Mouseover"] = "Mouseover"
L["Always display direction for mouseover"] = "Muestra dirección para pasar el ratón"
L["Target Unit"] = "Objetivo"
L["Always display direction for target"] = "Muestra dirección para la unidad en objetivo"
L["Focus Unit"] = "Foco"
...
L["Add heal spells"] = "Añade hechizos de sanación"
L["Raid Cooldowns"] = "Reutilizaciones de Banda"
...
L["Select heal spells"] = "Elige hechizos de sanación"
...
L["Shorten Above Million Numbers"] = "Acorta numeros por encima de un millón"
...
L["Incoming overheals below the specified value will not be shown."] = "No se mostrará la sobresanación por debajo del valor indicado."
L["Shorten Overhealing Numbers"] = "Acortar numeros (sobresanación)"
...
L["display damage absorb shields above max hp"] = "muestra escudos de absorción de daño por encima vida maxima"
...
L["Adjust Grid2 horizontal position."] = "Ajusta posición horizontal del Grid2"
L["Vertical Position"] = "Posición Vertical"
L["Adjust Grid2 vertical position."] = "Ajusta posición vertical del Grid2"
...
L["A Layout defines which unit frames will be displayed and the way in which they are arranged. Here you can set different layouts for each group or raid type."] = "Un diseño define que y como se mostrarán las unidades. Aqui puedes seleccionar diferentes diseños para cada tipo de grupo o banda."
L["Select zero to use default Frame Width"] = "Elige cero para usar el valor predeterminado para el ancho de los marcos."
L["Select zero to use default Frame Height"] = "Elige cero para usar el valor predeterminado para el alto de los marcos."
L["Are you sure?"] = "Estás seguro?"
L["A Layout defines which unit frames will be displayed and the way in which they are arranged. Here you can set different layouts for each raid size."] = "Un diseño define que y como se mostrarán las unidades. Aqui puedes seleccionar diferentes diseños para cada tamaño de banda."
L["Add instance size"] = "Añade tamaño de estancia"
L["Bar"] = "Barra"
L["Back"] = "Fondo"
L["Adjust"] = "Ajusta"
L["Horizontal Tiles"] = "Baldosas Horizontales"
L["Vertical Tiles"] = "Baldosas Verticales"
L["Repeat"] = "Repite"
L["Mirror"] = "Espejo"
L["Percent Format"] = "Formato Porcentajes"
L["Examples:\n%p\n%p percent"] = "Ejemplos:\n%p\n%p percent"
L["Raid Size"] = "Tamaño de Banda"
L["Choose the Raid Size calculation method"] = "Elige como calcular el tamaño de las bandas"
L["This setting is used to setup different layouts, frame sizes or themes depending of the raid size."] = "Permite seleccionar diferentes diseños, tamaños de marco o temas segun el tamaño de la banda."
L["Maximum capacity of the instance"] = "Capacidad maxima de la estancia"
L["Maximum non-empty raid group"] = "Maximo grupo de banda no vacio"
L["Number of non-empty raid groups"] = "Numero de grupos de banda en uso"
L["Number of players in raid"] = "Numero de jugadores en banda"

-- RaidDebuffsOptions
L["[Custom Debuffs]"] = "[Perjuicios Personalizados]"
L["Develop"] = "Desarrollo"
L["This instance is not empty. Are you sure you want to remove it ?"] = "Esta estancia no esta vacia. Seguro que la quieres eliminar ?"
L["Rename Boss"] = "Renombrar Jefe"
L["Move Up"] = "Mover Arriba"
L["Move debuff higher in the priority list."] = "Mover perjuicio hacia arriba en la lista de prioridades."
L["This debuff is already at the top of the list."] = "Este perjuicio ya esta en lo alto de la lista."
...
L["Assign autodetected raid debuffs to the specified status"] = "Asigna los perjuicios de banda autodetectados al estado selecionado."
L["Default difficulty for Encounter Journal links"] = "Dificultad predeterminada para la guía de aventuras"
L["multiple icons support"] = "soporte iconos múltiples"
L["Enable multiple icons support for icons indicators."] = "Activa la visualización de múltiples iconos."
...
L["Disabled in instances"] = "Desactivado en estancias"
L["Disable this status inside instances."] = "Desactiva este estado dentro de las estancias."
L["Display other groups"] = "Mostrar otros grupos"
L["Enable the status if the player is in another LFG or PvP instance."] = "Activa el estado si el jugador esta en otra estancia LFG o JcJ."
...
L["Player Class&Spec"] = "Jugador: Clase y Espec."
...
L["Load the status only if you are in the specified instance type."] = "Cargar el estado solo si estas dentro del tipo de estancia especificada."
...
L["Supports multiple names or IDs separated by commas or newlines.\n\nCurrent Instance:\n%s(%d)"] = "Soporta verios nombres o identificadores separados por comas o saltos de línea.\n\nInstancia Actual:\n%s(%d)"
...
L["Load the indicator only for the specified unit types."] = "Carga el indicador solo para los tipos de unidad indicadas."
L["Active Theme"] = "Tema Activo"
L["Load the indicator only for the specified themes."] = "Carga el indicador solo para los temas indicados."
...
L["Select layouts for different Raid types."] = "Elige los diseños para diferentes tipos de banda."
L["Use Blizzard Unit Frames"] = "Usar Marcos de Unidades de Blizzard"
L["Disable this option to use custom unit frames instead of blizzard frames. This fixes some bugs in blizzard code, but units cannot join/leave the roster while in combat."] = "Desactiva esta opción para usar marcos personalizados. Esto podria arreglar algunos bugs pero las unidades no pueden se pueden unir o abandonar la banda estando combate."
L["Detach all groups"] = "Separar todos los grupos"
L["Enable this option to detach unit frame groups, so each group can be moved individually."] = "Activa esta opción para separar los grupos de modo que cada grupo se pueda posiciónar individualmente."
L["Detach pets groups"] = "Separar grupos de mascotas"
L["Enable this option to detach the pets group, so pets group can be moved individually."] = "Activa esta opción para separar el grupo de mascotas de modo que el grupo se pueda posiciónar individualmente."
...
L["Show when all buffs are active"] = "Muestra con todos los beneficios activos"
L["Display the status only when all buffs are active."] = "Mostrar el estado solo cuando todos los beneficios estan presentes."
