...
L["Frame Background Color"] = "Color fondo de las celdas"
L["Sets the background color of each grid2 frame"] = "Elige el color de fondo de cada celda del Grid"
...
L["Range"] = "Rango"
L["%d yards"] = "%d yardas"
L["Range in yards beyond which the status will be lost."] = "Rango máximo en yardas para este estado"
