...
Grid2Options.indicatorTypesOrder= { tooltip = 1, alpha = 2, background = 3, border = 4, borderglow = 5, multibar = 6, bar = 7, text = 8, square = 9, shape = 10, icon = 11, icons = 12, portrait = 13 }
