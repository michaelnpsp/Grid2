-- Autogenerated: 2025/12/31 00:44:43
...
i["health-bar"] = { [1]={horTile="REPEAT",reverse=true,color={a=0.7,r=1,g=0,b=0.737},verTile="REPEAT",texture="Grid2 Shield"}, [2]={color={a=0.5}}, [3]={horTile="REPEAT",color={a=0.7},verTile="REPEAT",prevBar=1,texture="Grid2 Shield"}, [4]={color={a=1,r=0.965,g=0.992,b=1},glowLine=6,prevBar=-1,texture="Grid2 GlowH"}, textureColor={a=1}, location={y=0,relPoint="CENTER",point="CENTER",x=0}, level=3, type="multibar" }
