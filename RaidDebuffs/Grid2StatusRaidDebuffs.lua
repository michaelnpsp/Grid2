...
local spellDB = {
	...
	--63050, 63134, 63802
	[BZ["Trial of the Crusader"]] = { 66197, 66209, 66211, 66331, 66237, 66242, 66283, 66406, 66532, 66770, 66819, 66821, 66823, 66869, 67176, 67223, 67283, 67298, 67477, 67478, 67479, 67574, 67618, 67654, 66683, 66689 },
}
