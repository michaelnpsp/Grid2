...
do
	...
	if class=="SHAMAN" then Grid2.MakeDefaultsClass= function()
		...
		Grid2:DbSetMap( "icon-right", "raid-icon-target", 90)
	end elseif class=="EVOKER" then Grid2.MakeDefaultsClass= function()
		Grid2:DbSetValue( "statuses",  "buff-Echo-mine", {type = "buff", spellName = 364343, mine = true, color1 = {r=.8,g=.8,b=.2,a=1}})
		Grid2:DbSetValue( "statuses",  "buff-Reversion-mine", {type = "buff", spellName = 366155, mine= true, color1 = {r=.5,g=1,b=0,a=1}})
		Grid2:DbSetValue( "statuses",  "buff-DreamFlight-mine", {type = "buff", spellName = 359816, mine= true, color1 = {r=.4,g=.8,b=.2,a=1}})
		Grid2:DbSetValue( "indicators",  "corner-top-left", {type = "square", level = 9, location = Location("TOPLEFT"), size = 5,})
		Grid2:DbSetMap( "corner-top-left", "buff-Reversion-mine", 99)
		Grid2:DbSetValue( "indicators",  "side-top", {type = "square", level = 9, location= Location("TOP"), size = 5,})
		Grid2:DbSetMap( "side-top", "buff-Echo-mine", 89)
		Grid2:DbSetValue( "indicators",  "corner-top-right", {type = "square", level = 9, location= Location("TOPRIGHT"), size = 5,})
		Grid2:DbSetMap( "corner-top-right", "buff-DreamFlight-mine", 99)
		Grid2:DbSetMap( "border", "debuff-Magic"  , 90)
		Grid2:DbSetMap( "border", "debuff-Poison" , 80)
		Grid2:DbSetMap( "border", "debuff-Curse"  , 70)
		Grid2:DbSetMap( "border", "debuff-Disease", 60)
